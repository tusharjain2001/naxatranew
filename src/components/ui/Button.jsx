...
const padding = {
  solid: { md: 'px-32 py-16', hero: 'px-32 py-16', sm: 'px-19.25 py-9.5', xs: 'px-18.5 py-9.25' },
  outline: { md: 'border-2 px-30 py-14', hero: 'border-2 px-30 py-14', sm: 'border px-18.25 py-8.5', xs: 'border px-17.5 py-8.25' },
}
