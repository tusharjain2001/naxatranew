...
export const findByApplications = [
  { key: 'ride-on-sweeper', name: 'Ride on Sweeper', industry: 'Cleaning', image: L('app-sweeper.png'), motors: [motor('RF 15/42', 'Steering'), motor('RF 22/42', 'Steering'), motor('RF 15/42', 'Traction'), motor('RF 22/42', 'Traction')] },
