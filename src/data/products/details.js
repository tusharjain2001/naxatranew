...
export const detailBySlug = {
  ...
  rf22: mkDetail('rf22', 'Product/ RF Series/ RF 22', [
    mkVariant('RF 22/42', { hero: RF22 + 'hero.png', heroClass: 'xl:left-[calc(var(--spacing)*308.7)] xl:top-[calc(var(--spacing)*168.7)] xl:w-[calc(var(--spacing)*618)] xl:h-[calc(var(--spacing)*601.4)]', mobileHeroClass: 'left-[calc(var(--spacing)*65.9)] top-[calc(var(--spacing)*139)] w-[calc(var(--spacing)*368.6)] h-[calc(var(--spacing)*358.6)]', vim: [RF22 + 'g42-1.png', RF22 + 'g42-2.png'], mvim: [RF22 + 'mg42-1.png', RF22 + 'mg42-2.png'], mthumb: RF22 + 'mthumb-42.jpg', thumb: STD_THUMB, note: SAME_DIE, voltage: '48 V / 72 V', power: '2.2 kW', torque: '9.5 Nm', peakSpeed: '5000 RPM', efficiency: '>94%', mass: '6.5 Kg' }),
    mkVariant('RF 22/60', { hero: RF22 + 'hero.png', heroClass: 'xl:left-[calc(var(--spacing)*308.7)] xl:top-[calc(var(--spacing)*168.7)] xl:w-[calc(var(--spacing)*618)] xl:h-[calc(var(--spacing)*601.4)]', mobileHeroClass: 'left-[calc(var(--spacing)*65.9)] top-[calc(var(--spacing)*139)] w-[calc(var(--spacing)*368.6)] h-[calc(var(--spacing)*358.6)]', vim: [RF22 + 'g60-1.png', RF22 + 'g60-2.png'], mvim: [RF22 + 'mg60-1.png', RF22 + 'mg60-2.png'], mthumb: RF22 + 'mthumb-60.jpg', thumb: STD_THUMB, note: SAME_DIE, voltage: '48 V / 72 V', power: '2.2 kW', torque: '9.5 Nm', peakSpeed: '5000 RPM', efficiency: '>92%', mass: '6.5 Kg' }),
    mkVariant('RF 22/86', { hero: RF22 + 'hero-86.png', heroClass: 'xl:left-[calc(var(--spacing)*222.5)] xl:top-[calc(var(--spacing)*40.5)] xl:w-[calc(var(--spacing)*850)] xl:h-[calc(var(--spacing)*840)]', mobileHeroClass: 'left-[calc(var(--spacing)*28.7)] top-[calc(var(--spacing)*93.4)] w-[calc(var(--spacing)*446.3)] h-[calc(var(--spacing)*441)]', vim: [RF22 + 'g86-1.png', RF22 + 'g86-2.png'], mvim: [RF22 + 'mg86-1.png', RF22 + 'mg86-2.png'], mthumb: RF22 + 'mthumb-86.jpg', thumb: RF22 + 'thumb-86.png', note: DISTINCT_HOUSING, voltage: '48 V / 72 V', power: '2.2 kW', torque: '9.5 Nm', peakSpeed: '5000 RPM', efficiency: '>94%', mass: '6.5 Kg' }),
